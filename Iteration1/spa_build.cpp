...
int _tmain(int argc, _TCHAR* argv[]) {
	...
	// 4. While x {
	Node* s4 = pkb.createNode(whileLoop, 4);
	...
	Node* s5v_z = pkb.createNode(variable, 5, "z", s5, nullptr, nullptr, proc);
	Node* s5e_plus1 = pkb.createNode(expression, 5, "+", s5, nullptr, nullptr, proc);
	Node* s5v_y = pkb.createNode(variable, 5, "y", s5, nullptr, nullptr, proc);
	Node* s5e_plus2 = pkb.createNode(expression, 5, "+", s5, nullptr, nullptr, proc);
	Node* s5v_x = pkb.createNode(variable, 5, "x", s5, nullptr, nullptr, proc);
	s5->setLeftChild(s5a);
	...
	Node* s6v_a = pkb.createNode(variable, 6, "a", s6, nullptr, nullptr, proc);
	Node* s6e_plus = pkb.createNode(expression, 6, "+", s6, nullptr, nullptr, proc);
	Node* s6v_z = pkb.createNode(variable, 6, "z", s6, nullptr, nullptr, proc);
	s6->setLeftChild(s6a);
	...
	Node* s7v_z = pkb.createNode(variable, 7, "z", s7, nullptr, nullptr, proc);
	Node* s7e_plus = pkb.createNode(expression, 7, "+", s7, nullptr, nullptr, proc);
	Node* s7v_x = pkb.createNode(variable, 7, "x", s7, nullptr, nullptr, proc);
	s7->setLeftChild(s7a);
