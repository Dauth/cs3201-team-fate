...
public:
	...
	void setupAssignVarListNode(std::string line, int lineNumber, std::vector<Twin*>& twinVector, unsigned i, std::string varName, Node* procNode, Node*& assignStm, std::string&, int&, std::vector<int>&);
	...
	void createCallNode(std::string stmName, int lineNumber, std::string& currentProcName, std::vector<Twin*>& twinVector, unsigned i, std::string&, int&, std::vector<int>&);
	void createProcNode(std::string& currentProcName, std::vector<Node*>& mainProg, std::stack<std::string>& bracesStack, std::vector<Twin*>& twinVector, unsigned i, std::string&, int&, std::vector<int>&);
	void createAssignNode(std::string line, int lineNumber, std::vector<Twin*>& twinVector, unsigned i, std::string&, int&, std::vector<int>&);
	void createWhileNode(std::string varName, int lineNumber, std::vector<Twin*>& twinVector, std::string&, int&, std::vector<int>&);
	void createIfElseNode(std::string varName, int lineNumber, std::vector<Twin*>& twinVector, std::string&, int&, std::vector<int>&);
