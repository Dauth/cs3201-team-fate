...
class PKBFacade {
	...
	private:
		...
		void handleModifiesInheritance(vector<string>, Node*, Node*);
		void handleUsesInheritance(vector<string>, Node*, Node*);
		void handleCalls(Node*, Node*, Node*);
		void handleModifiesCalls(vector<pair<string, string>>, vector<string>, Node*, Node*, Node*);
		void handleUsesCalls(vector<pair<string, string>>, vector<string>, Node*, Node*, Node*);
